...
func main() {
	...
	//r.POST("/upload", func(c *miniweb.Context) {
	//	randUUID1 := uuid.New().String()
	//
	//	file, err := c.FormFile("file")
	//	if err != nil {
	//		c.String(500, "上传文件出错")
	//	}
	//	filepath := "dashijian\\web\\image\\" + randUUID1 + file.Filename
	//	c.SaveUploadedFile(file, filepath)
	//
	//	baseurl1 := fmt.Sprintf("http://%s:%d/getImageName?imageName=", "127.0.0.1", 9090)
	//
	//	url := baseurl1 + randUUID1 + file.Filename
	//	//	url := "http://127.0.0.1:9097/getImageName?imageName=" + randUUID1 + file.Filename
	//
