...
func InitDB() {
	...
	conn := "root:123456@tcp(localhost:3306)/da_shi_jian_article_category?charset=utf8mb4&parseTime=True&loc=Local"
	...
	fmt.Println("连接成功....")
	err = DB.AutoMigrate(&model.Category{}, &model.Article{})
	if err != nil {
		panic("Category/Article建表失败")
	}
